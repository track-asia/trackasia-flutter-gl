# Flutter Maplibre GL
[![Flutter CI](https://github.com/track-asia-vn/flutter-maplibre-gl/actions/workflows/flutter_ci.yml/badge.svg)](https://github.com/track-asia-vn/flutter-maplibre-gl/actions/workflows/flutter_ci.yml)
[![Generate docs](https://github.com/track-asia-vn/flutter-maplibre-gl/actions/workflows/generate_docs.yml/badge.svg)](https://github.com/track-asia-vn/flutter-maplibre-gl/actions/workflows/generate_docs.yml)

> ``⚠️`` Current notice: the repository has been transferred to the @maplibre organization. You shouldn't see any negative effects, as GitHub automatically redirects references from the old URL to the new URL. Please see [#221](https://github.com/track-asia-vn/flutter-maplibre-gl/issues/221) for more information.

This Flutter plugin allows to show **embedded interactive and customizable vector maps** as a Flutter widget. 

For the Android and iOS integration, we use [maplibre-gl-native](https://github.com/track-asia-vn/trackasia-gl-native). For web, we rely on [maplibre-gl-js](https://github.com/track-asia-vn/trackasia-gl-js). This project only supports a subset of the API exposed by these libraries. 
...
dependencies:
    ...
    maplibre_gl:
      git:
        url: https://github.com/track-asia-vn/flutter-maplibre-gl.git
        ref: main
```
This will get you the very latest changes from the main branch.
You can replace `main` with the name of the [latest release](https://github.com/track-asia-vn/flutter-maplibre-gl/releases)
...
### Documentation
Documentation is available on the docs branch in the doc/api folder and automatically updated on each push to the main branch. You can easily preview the [documentation / API reference here.](https://htmlpreview.github.io/?https://github.com/track-asia-vn/flutter-maplibre-gl/blob/docs/doc/api/index.html)
