...
import 'package:trackasia_gl_web/src/geo/point.dart';
import 'package:trackasia_gl_web/src/style/layers/layer.dart';
...
import 'package:trackasia_gl_web/src/style/sources/vector_source.dart';
import 'package:trackasia_gl_web/src/style/style.dart';
import 'package:trackasia_gl_web/src/ui/camera.dart';
import 'package:trackasia_gl_web/src/ui/handler/box_zoom.dart';
import 'package:trackasia_gl_web/src/ui/handler/dblclick_zoom.dart';
import 'package:trackasia_gl_web/src/ui/handler/drag_pan.dart';
import 'package:trackasia_gl_web/src/ui/handler/drag_rotate.dart';
import 'package:trackasia_gl_web/src/ui/handler/keyboard.dart';
import 'package:trackasia_gl_web/src/ui/handler/scroll_zoom.dart';
import 'package:trackasia_gl_web/src/ui/handler/touch_zoom_rotate.dart';
...
class TrackAsiaMap extends Camera {
  ...
  // TrackAsiaMap on(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  /// Return each layer of the  TrackAsia style object, which can be used to check the order, toggle the visibility or change properties
  ...
  TrackAsiaMap addSource(String id, dynamic source) {
    ...
    return TrackAsiaMap.fromJsObject(jsObject.addSource(id, jsify(source)));
  }
  ...
  /// Creates a new TrackAsiaMap from a [jsObject].
  TrackAsiaMap.fromJsObject(this.jsObject) : super.fromJsObject(jsObject);
}
...
class IControl extends JsObjectWrapper<IControlJsImpl> {
  ...
  ///  internally.
  HtmlElement onAdd(TrackAsiaMap map) => jsObject.onAdd(map.jsObject);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link TrackAsiaMap#removeControl}
  ///  internally.
  onRemove(TrackAsiaMap map) => jsObject.onRemove(map.jsObject);
