@JS('trackasiagl')
library trackasia.interop.ui.camera;
...
import 'package:trackasia_gl_web/src/interop/util/evented_interop.dart';
...
abstract class CameraJsImpl extends EventedJsImpl {
  ...
  ///  // zoom the map to 5
  ///  map.setZoom(5);
  external TrackAsiaMapJsImpl setZoom(num zoom, [dynamic eventData]);
  ...
  ///  map.setBearing(90);
  external TrackAsiaMapJsImpl setBearing(num bearing, [dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {TrackAsiaMap} `this`
  external TrackAsiaMapJsImpl setPitch(num pitch, [dynamic eventData]);
  ...
  ///  @memberof TrackAsiaMap#
  ///  @returns {TrackAsiaMap} `this`
  external TrackAsiaMapJsImpl stop();
}
