@JS('trackasiagl')
library trackasia.interop.ui.marker;
...
import 'package:trackasia_gl_web/src/interop/ui/popup_interop.dart';
...
class MarkerJsImpl extends EventedJsImpl {
  ...
  ///  @returns {Marker} `this`
  external MarkerJsImpl addTo(TrackAsiaMapJsImpl map);
