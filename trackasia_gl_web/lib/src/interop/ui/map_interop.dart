@JS('trackasiagl')
library trackasia.interop.ui.map;

import 'dart:html';
import 'package:js/js.dart';
import 'package:trackasia_gl_web/src/interop/geo/geojson_interop.dart';
import 'package:trackasia_gl_web/src/interop/geo/lng_lat_bounds_interop.dart';
import 'package:trackasia_gl_web/src/interop/geo/lng_lat_interop.dart';
import 'package:trackasia_gl_web/src/interop/geo/point_interop.dart';
import 'package:trackasia_gl_web/src/interop/style/style_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/camera_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/box_zoom_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/dblclick_zoom_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/drag_pan_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/drag_rotate_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/keyboard_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/scroll_zoom_interop.dart';
import 'package:trackasia_gl_web/src/interop/ui/handler/touch_zoom_rotate_interop.dart';

///  The `TrackAsiaMap` object represents the map on your page. It exposes methods
///  and properties that enable you to programmatically change the map,
///  and fires events as users interact with it.
///
///  You create a `TrackAsiaMap` by specifying a `container` and other options.
///  Then TrackAsia JS JS initializes the map on the page and returns your `TrackAsiaMap`
///  object.
///
///  ```dart
...
@JS('Map')
class TrackAsiaMapJsImpl extends CameraJsImpl {
  external factory TrackAsiaMapJsImpl(MapOptionsJsImpl options);
  ...
  external TrackAsiaMapJsImpl addControl(IControlJsImpl? control, [String? position]);
  ...
  external TrackAsiaMapJsImpl removeControl(IControlJsImpl? control);
  ...
  external TrackAsiaMapJsImpl resize([dynamic eventData]);
  ...
  external TrackAsiaMapJsImpl setMaxBounds(LngLatBoundsJsImpl? bounds);
  ...
  external TrackAsiaMapJsImpl setMinZoom([num? minZoom]);
  ...
  external TrackAsiaMapJsImpl setMaxZoom([num? maxZoom]);
  ...
  ///  @returns {TrackAsiaMap} `this`
  external TrackAsiaMapJsImpl setMinPitch([num? minPitch]);
  ...
  ///  @returns {TrackAsiaMap} `this`
  external TrackAsiaMapJsImpl setMaxPitch([num? maxPitch]);
  ...
  ///  @see [Render world copies](https://track-asia.com/trackasia-gl-js/docs/examples/render-world-copies/)
  external TrackAsiaMapJsImpl setRenderWorldCopies([bool? renderWorldCopies]);
  ...
  //external TrackAsiaMap on(String type, [dynamic layerIdOrListener, Listener listener]);

  ///  Removes an event listener for layer-specific events previously added with `TrackAsiaMap#on`.
  ///
  ...
  ///  @returns {TrackAsiaMap} `this`
  // Defined in evented.dart
  //external TrackAsiaMap off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  Omitting this parameter (i.e. calling [TrackAsiaMap.queryRenderedFeatures] with zero arguments,
  ///  or with only a [options] argument) is equivalent to passing a bounding box encompassing the entire
  ///  map viewport.
  ///  @param {Object} [options]
  ///  @param {Array<string>} `options.layers` An array of [style layer IDs](https://track-asia.com/trackasia-style-spec/#layer-id) for the query to inspect.
  ///    Only features within these layers will be returned. If this parameter is undefined, all layers will be checked.
  ///  @param {Array} `options.filter` A [filter](https://track-asia.com/trackasia-style-spec/#other-filter)
  ///    to limit query results.
  ///  @param {boolean} [options.validate=true] Whether to check if the `options.filter` conforms to the TrackAsia JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///
  ...
  external List<FeatureJsImpl> queryRenderedFeatures(dynamic geometry, [dynamic options]);
  ...
  ///  @param {Array} `parameters.filter` A [filter](https://track-asia.com/trackasia-style-spec/#other-filter)
  ///    to limit query results.
  ///  @param {boolean} `parameters.validate=true` Whether to check if the `parameters.filter` conforms to the TrackAsia JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///
  ///  @returns {Array<Object>} An array of [GeoJSON](http://geojson.org/)
  ///  [Feature objects](https://tools.ietf.org/html/rfc7946#section-3.2).
  ///
  ///  In contrast to [TrackAsiaMap.queryRenderedFeatures], this function returns all features matching the query parameters,
  ...
  ///    [TrackAsia Style Specification](https://track-asia.com/trackasia-style-spec/), or a URL to such JSON.
  ///  @param {Object} [options]
  ...
  external TrackAsiaMapJsImpl setStyle(dynamic style, [dynamic options]);
  ...
  ///  TrackAsia Style Specification's [source definition](https://track-asia.com/trackasia-style-spec/#sources) or
  ///  [CanvasSourceOptions].
  ///  @fires source.add
  ///  @returns {TrackAsiaMap} `this`
  ...
  external TrackAsiaMapJsImpl addSource(String id, dynamic source);
  ...
  ///  [`icon-image`](https://track-asia.com/trackasia-style-spec/#layout-symbol-icon-image),
  ///  [`background-pattern`](https://track-asia.com/trackasia-style-spec/#paint-background-background-pattern),
  ///  [`fill-pattern`](https://track-asia.com/trackasia-style-spec/#paint-fill-fill-pattern),
  ///  or [`line-pattern`](https://track-asia.com/trackasia-style-spec/#paint-line-line-pattern).
  ///  A {@link TrackAsiaMap#error} event will be fired if there is not enough space in the sprite to add this image.
  ///
  ...
  ///  Load an image from an external URL to be used with `TrackAsiaMap#addImage`. External
  ...
  ///  Adds a [TrackAsia style layer](https://track-asia.com/trackasia-style-spec/#layers)
  ///  to the map's style.
  ///
  ///  A layer defines how data from a specified source will be styled. Read more about layer types
  ///  and available paint and layout properties in the [TrackAsia Style Specification](https://track-asia.com/trackasia-style-spec/#layers).
  ///
  ///  @param {Object | CustomLayerInterface} layer The style layer to add, conforming to the TrackAsia Style Specification's
  ///    [layer definition](https://track-asia.com/trackasia-style-spec/#layers).
  ...
  external TrackAsiaMapJsImpl addLayer(dynamic layer, [String? beforeId]);
  ...
  external TrackAsiaMapJsImpl moveLayer(String id, String beforeId);
  ...
  ///  [minimum zoom level](https://track-asia.com/trackasia-style-spec/#layer-minzoom)
  ///  and [maximum zoom level](https://track-asia.com/trackasia-style-spec/#layer-maxzoom))
  ...
  external TrackAsiaMapJsImpl setLayerZoomRange(String layerId, num minzoom, num maxzoom);

  ///  Sets the filter for the specified style layer.
  ///
  ///  @param {string} layerId The ID of the layer to which the filter will be applied.
  ///  @param {Array | null | undefined} filter The filter, conforming to the TrackAsia Style Specification's
  ///    [filter definition](https://track-asia.com/trackasia-style-spec/#other-filter).  If `null` or `undefined` is provided, the function removes any existing filter from the layer.
  ///  @param {Object} [options]
  ...
  external TrackAsiaMapJsImpl setFilter(String layerId, dynamic filter, [StyleSetterOptionsJsImpl? options]);
  ...
  ///    Must be of a type appropriate for the property, as defined in the [TrackAsia Style Specification](https://track-asia.com/trackasia-style-spec/).
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if `value` conforms to the TrackAsia JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {TrackAsiaMap} `this`
  ///  @example
  ...
  ///  @see [Create a draggable point](https://track-asia.com/trackasia-gl-js/docs/examples/drag-a-point/)
  external setPaintProperty(String layerId, String name, dynamic value, [StyleSetterOptionsJsImpl? options]);
  ...
  ///  @param {*} value The value of the layout property. Must be of a type appropriate for the property, as defined in the [TrackAsia Style Specification](https://track-asia.com/trackasia-style-spec/).
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if `value` conforms to the TrackAsia JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {TrackAsiaMap} `this`
  ///  @example
  ///  map.setLayoutProperty('my-layer', 'visibility', 'none');
  external TrackAsiaMapJsImpl setLayoutProperty(String layerId, String name, dynamic value, [StyleSetterOptionsJsImpl? options]);
  ...
  ///
  ///  @param light Light properties to set. Must conform to the [TrackAsia Style Specification](https://track-asia.com/trackasia-style-spec/#light).
  ///  @param {Object} [options]
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the TrackAsia JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {TrackAsiaMap} `this`
  external TrackAsiaMapJsImpl setLight(dynamic light, StyleSetterOptionsJsImpl options);
  ...
  ///  [TrackAsiaMap.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  ///  Feature objects returned from [TrackAsiaMap.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  ///  The version of TrackAsia JS JS in use as specified in package.json, CHANGELOG.md, and the GitHub release.
  ///
  ///  @name version
  ///  @instance
  ///  @memberof TrackAsiaMap
...
class MapOptionsJsImpl {
  ...
  /// The HTML element in which TrackAsia JS JS will render the map, or the element's string `id`. The specified element must have no children.
  ...
  /// A string representing the position of the TrackAsia wordmark on the map. Valid options are `top-left`,`top-right`, `bottom-left`, `bottom-right`.
  ...
  ///  The map's TrackAsia style. This must be an a JSON object conforming to
  ///  the schema described in the [TrackAsia Style Specification](https://track-asia.com/trackasia-style-spec/), or a URL to
  ///  such JSON.
  ...
  /// The inital geographical centerpoint of the map. If `center` is not specified in the constructor options, TrackAsia JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `[0, 0]` Note: TrackAsia JS uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
  external LngLatJsImpl get center;

  /// The initial zoom level of the map. If `zoom` is not specified in the constructor options, TrackAsia JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
  external num get zoom;

  /// The initial bearing (rotation) of the map, measured in degrees counter-clockwise from north. If `bearing` is not specified in the constructor options, TrackAsia JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
  external num get bearing;

  /// The initial pitch (tilt) of the map, measured in degrees away from the plane of the screen (0-60). If `pitch` is not specified in the constructor options, TrackAsia JS JS will look for it in the map's style object. If it is not specified in the style, either, it will default to `0`.
  ...
  external RequestTransformFunctionJsImpl get transformRequest; //TODO: Remove JsImpl
...
typedef RequestTransformFunctionJsImpl = RequestParametersJsImpl Function(String url, String resourceType);
...
///  element, which is often a `div` element. To use TrackAsia JS JS's
...
///
///   @override
///   HtmlElement onAdd(TrackAsiaMap map) {
...
abstract class IControlJsImpl {
  ...
  ///  and resources. This method is called by {@link TrackAsiaMap#addControl}
  ///  internally.
  external HtmlElement onAdd(TrackAsiaMapJsImpl map);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link TrackAsiaMap#removeControl}
  ///  internally.
  external onRemove(TrackAsiaMapJsImpl map);

  ///  Optionally provide a default position for this control. If this method
  ///  is implemented and {@link TrackAsiaMap#addControl} is called without the `position`
