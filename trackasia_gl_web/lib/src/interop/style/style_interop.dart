@JS('trackasiagl')
library trackasia.interop.style.style;

import 'package:js/js.dart';
import 'package:trackasia_gl_web/src/interop/style/evaluation_parameters_interop.dart';
import 'package:trackasia_gl_web/src/interop/style/style_image_interop.dart';
...
abstract class StyleJsImpl extends EventedJsImpl {
  ...
  addLayer(dynamic layerObject, [String? before, StyleSetterOptionsJsImpl? options]);
  ...
  setLayoutProperty(String layerId, String name, dynamic value, StyleSetterOptionsJsImpl options);
  ...
  setPaintProperty(String layerId, String name, dynamic value, StyleSetterOptionsJsImpl options);
