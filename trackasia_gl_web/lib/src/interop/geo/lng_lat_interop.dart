@JS('trackasiagl')
library trackasia.interop.geo.lng_lat;
...
///
///  TrackAsia JS uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
///
///  Note that any TrackAsia JS method that accepts a `LngLat` object as an argument or option
...
class LngLatJsImpl {
  ...
  ///  @example
  ///  var ll = new trackasiagl.LngLat(286.0251, 40.7736);
  ///  var wrapped = ll.wrap();
  ///  wrapped.lng; // = -73.9749
