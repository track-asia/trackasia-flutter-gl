...
#else
// MARK: - Swift Fallback Definitions (when ObjC module not available)

/**
 Keys in the user info dictionaries of various notifications posted by instances
 of `RouteController`.
 */
public struct RouteControllerNotificationUserInfoKey: RawRepresentable, Hashable {
    public let rawValue: String
    public init(rawValue: String) { self.rawValue = rawValue }
    
    public static let routeProgressKey = RouteControllerNotificationUserInfoKey(rawValue: "routeProgress")
    public static let locationKey = RouteControllerNotificationUserInfoKey(rawValue: "location")
    public static let rawLocationKey = RouteControllerNotificationUserInfoKey(rawValue: "rawLocation")
    public static let errorKey = RouteControllerNotificationUserInfoKey(rawValue: "error")
    public static let routingErrorKey = RouteControllerNotificationUserInfoKey(rawValue: "routingError")
    public static let isProactiveKey = RouteControllerNotificationUserInfoKey(rawValue: "isProactive")
}

public extension Notification.Name {
    static let routeControllerDidFailToReroute = Notification.Name("MBRouteControllerDidFailToReroute")
    static let routeControllerWillReroute = Notification.Name("MBRouteControllerWillReroute")
    static let routeControllerDidReroute = Notification.Name("MBRouteControllerDidReroute")
    static let routeControllerProgressDidChange = Notification.Name("MBRouteControllerProgressDidChange")
    static let routeControllerDidPassSpokenInstructionPoint = Notification.Name("MBRouteControllerDidPassSpokenInstructionPoint")
