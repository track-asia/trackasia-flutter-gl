...
class ImageDownloadOperation: Operation, ImageDownload {
    ...
    private let barrierQueue = DispatchQueue(label: (Bundle.mapboxNavigation.bundleIdentifier ?? "com.mapbox.navigation") + ".ImageDownloadCompletionBarrierQueue", attributes: .concurrent)
