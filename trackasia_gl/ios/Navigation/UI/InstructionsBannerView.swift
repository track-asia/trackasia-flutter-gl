...
open class BaseInstructionsBannerView: UIControl {
    ...
    override open func prepareForInterfaceBuilder() {
        ...
        let textRep = VisualInstruction.Component.TextRepresentation(text: "Primary text label", abbreviation: nil, abbreviationPriority: nil)
        let component = VisualInstruction.Component.text(text: textRep)
