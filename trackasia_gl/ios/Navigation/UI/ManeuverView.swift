...
open class ManeuverView: UIView {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        case .takeRoundabout, .turnAtRoundabout, .takeRotary:
            let heading = visualInstruction.finalHeading ?? 0
            ManeuversStyleKit.drawRoundabout(frame: bounds, resizing: resizing, primaryColor: self.primaryColor, secondaryColor: self.secondaryColor, roundabout_angle: CGFloat(heading))
