...
// MARK: - VisualInstructionDelegate Default Implementation
public extension VisualInstructionDelegate {
    func label(_ label: InstructionLabel, willPresent instruction: VisualInstruction, as presented: NSAttributedString) -> NSAttributedString? { presented }
}
