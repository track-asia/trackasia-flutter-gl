...
public protocol NavigationViewControllerDelegate: VisualInstructionDelegate {
     ...
     */
    func navigationViewController(_ navigationViewController: NavigationViewController, didFinishLoading style: MLNStyle)
    ...
    /**
     ...
     - parameter waypoint: The waypoint that the user has arrived at. May be nil if destination is not available.
     ...
     */
    func navigationViewController(_ navigationViewController: NavigationViewController, routeStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer?
     ...
     */
    func navigationViewController(_ navigationViewController: NavigationViewController, routeCasingStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer?
     ...
     */
    func navigationViewController(_ navigationViewController: NavigationViewController, waypointStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer?
     ...
     */
    func navigationViewController(_ navigationViewController: NavigationViewController, waypointSymbolStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer?
    ...
    func navigationViewController(_ navigationViewController: NavigationViewController, shapeFor waypoints: [Waypoint], legIndex: Int) -> MLNShape?
     ...
     */
    func navigationViewController(_ navigationViewController: NavigationViewController, didSelect annotation: MLNAnnotation)
    ...
    func navigationViewController(_ navigationViewController: NavigationViewController, viewFor annotation: MLNAnnotation) -> MLNAnnotationView?
...
open class NavigationViewController: UIViewController {
    ...
    public var route: Route? {
        didSet {
            ...
            if let route {
                ...
                // Note: routeOptions.locale not directly accessible in MapboxDirections 2.x
                // Using system locale to determine metric preference
                NavigationSettings.shared.distanceUnit = Locale.current.usesMetric ? .kilometer : .mile
    ...
    public func startNavigation(with route: Route, animated: Bool, routeController: RouteController? = nil, locationManager: NavigationLocationManager = NavigationLocationManager()) {
        ...
        // Note: Checking route options type - in MapboxDirections 2.x, this check may not be reliable
        // Proceeding with navigation anyway
...
// MARK: - NavigationViewControllerDelegate Default Implementations
public extension NavigationViewControllerDelegate {
    func navigationViewControllerDidFinishRouting(_ navigationViewController: NavigationViewController) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, didFinishLoading style: MLNStyle) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, didArriveAt waypoint: Waypoint?) -> Bool { true }
    func navigationViewController(_ navigationViewController: NavigationViewController, shouldRerouteFrom location: CLLocation) -> Bool { true }
    func navigationViewController(_ navigationViewController: NavigationViewController, willRerouteFrom location: CLLocation) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, didRerouteAlong route: Route) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, didFailToRerouteWith error: Error) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, routeStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, routeCasingStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, shapeFor routes: [Route]) -> MLNShape? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, simplifiedShapeFor route: Route) -> MLNShape? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, waypointStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, waypointSymbolStyleLayerWithIdentifier identifier: String, source: MLNSource) -> MLNStyleLayer? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, shapeFor waypoints: [Waypoint], legIndex: Int) -> MLNShape? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, didSelect route: Route) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, didSelect annotation: MLNAnnotation) {}
    func navigationViewController(_ navigationViewController: NavigationViewController, imageFor annotation: MLNAnnotation) -> MLNAnnotationImage? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, viewFor annotation: MLNAnnotation) -> MLNAnnotationView? { nil }
    func navigationViewController(_ navigationViewController: NavigationViewController, mapViewUserAnchorPoint mapView: NavigationMapView) -> CGPoint { .zero }
    func navigationViewController(_ navigationViewController: NavigationViewController, shouldDiscard location: CLLocation) -> Bool { false }
    func navigationViewController(_ navigationViewController: NavigationViewController, roadNameAt location: CLLocation) -> String? { nil }
}
